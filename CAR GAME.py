    ...
    def __init__(self,screenw,screenh,cameraangled,efficientpolygons,dynamiccamera,particlequantity,frameskip,playernum,aicarid,aicarnum):
        ...
        for a in range(playernum):
            if a in self.aicarid:
                self.cars.append(AIPOWEREDCAR(200,200+a*100,(255,0,0),100,50,1000,1000,500,100,500,self.materials,imagedata[a%4],a,keydata[a],self.tabs[a]))
            else:   
        ...
        for a in range(aicarnum):
            self.cars.append(AIPOWEREDCAR(200,200+(a+playernum+1)*100,(255,0,0),100,50,1000,1000,500,100,500,self.materials,imagedata[(a+1)%4],a,keydata[2],self.tabs[a]))
...
main = MAIN(2400,1350,False,True,True,1,2,1,[0],0)
main.main()
pygame.quit()
